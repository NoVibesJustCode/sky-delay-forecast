...
1.  **Start the Broker**: Ensure your message broker (e.g., ActiveMQ) is active and reachable.
    ...
    _Default broker URL: tcp://localhost:61616_
...
3.  **OpenWeatherMap Feeder**:
    Requires the broker URL, the topic names (weather and forecast) and an external file containing airport information (IATA codes, locations, etc.). 
